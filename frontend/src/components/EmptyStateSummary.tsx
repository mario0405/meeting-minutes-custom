  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-500 mb-6 max-w-md">
        Erstelle eine KI-Zusammenfassung deines Meeting-Transkripts, um die wichtigsten Punkte und Aufgaben zu erhalten.
      </p>
      ...
      <TooltipProvider>
        <Tooltip>
          ...
          {!hasModel && (
            <TooltipContent>
              <p>Bitte zuerst ein Modell in den Einstellungen auswählen</p>
            </TooltipContent>
          )}
        </Tooltip>
      </TooltipProvider>
      ...
      {!hasModel && (
        <p className="text-xs text-amber-600 mt-3">
          Bitte zuerst ein Modell in den Einstellungen auswählen
        </p>
      )}
    </motion.div>
  );

  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-gray-900 text-white rounded-lg shadow-lg">
              <p className="font-semibold mb-1">Aufnahmemethoden:</p>
              ...
              <p className="mt-2 text-gray-300">
                Probiere verschiedene Backends aus, um herauszufinden, was auf deinem System am besten funktioniert.
              </p>
            </div>
          )}
        </div>
      ...
      <div className="text-xs text-gray-500 space-y-1">
        <p>• Die Auswahl betrifft nur die Systemaudio-Aufnahme</p>
        <p>• Das Mikrofon nutzt immer die Standardmethode</p>
        <p>• Änderungen gelten für neue Aufnahmen</p>
      </div>
    </div>
  );
}
